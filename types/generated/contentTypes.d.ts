...
export interface ApiAnoAno extends Struct.CollectionTypeSchema {
  collectionName: 'anos';
  info: {
    displayName: 'Ano';
    pluralName: 'anos';
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::ano.ano'> &
      Schema.Attribute.Private;
    projetos: Schema.Attribute.Relation<'oneToMany', 'api::projeto.projeto'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjetoProjeto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ano: Schema.Attribute.Relation<'manyToOne', 'api::ano.ano'>;
